...
public class DynamicFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        MainActivity main = (MainActivity)getActivity(); //instancie ma classe activity dans laquelle se trouve le fragment
        Log.i("fragment", main.myString);                // accède aux variables de mon activity
    }
